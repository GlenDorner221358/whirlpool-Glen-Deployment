...
function Landing() {
    ...
    useEffect(() => {
        Axios.get('https://whirlpoolglen-89e5682b847b.herokuapp.com/api/allQuestions')
            .then(res => {
    ...
    useEffect(() => {
        Axios.get(`https://whirlpoolglen-89e5682b847b.herokuapp.com/api/allQuestions?tag=${selectedTag || ''}`)
            .then(res => {
                let productData = res.data;
                let slicedArray = [];
