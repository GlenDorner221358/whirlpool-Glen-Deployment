...
function SingleComment() {
    ...
    useEffect(() => {
        axios.get("https://whirlpoolglen-89e5682b847b.herokuapp.com/api/comments/" + queTitle)
            .then((res) => {
    ...
    const handleLike = async (commentID, commentLikes) => {
        if (!isLiked) {
            ...
            axios.patch('https://whirlpoolglen-89e5682b847b.herokuapp.com/api/updateComment/' + commentID, payload)
                .then(res => {
                    if (res) {
    ...
    const handleDelete = async (commentID) => {
        if (permissions === 'true') {
            try {
                await axios.delete('https://whirlpoolglen-89e5682b847b.herokuapp.com/api/deleteComment/' + commentID);
