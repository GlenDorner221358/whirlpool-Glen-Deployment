...
function SingleQuestion() {
    ...
    const handleDelete = async () => {
        try {
            await axios.delete('https://whirlpoolglen-89e5682b847b.herokuapp.com/api/deleteQuestion/' + question.id);
            axios.delete('https://whirlpoolglen-89e5682b847b.herokuapp.com/api/deleteComments/' + question.title);
    ...
    useEffect(() => {
        axios.get('https://whirlpoolglen-89e5682b847b.herokuapp.com/api/singleQuestion/' + question.id)
            .then(res => {
                let data = res.data;
                setWienerBalls(data);
                console.log(JSON.stringify(data.image));

                setQuePic("https://whirlpoolglen-89e5682b847b.herokuapp.com/questionImages/" + data.image)
